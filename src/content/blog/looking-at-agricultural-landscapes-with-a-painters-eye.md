...
A painter needs time, patience and an idea of what they want to show. They sketch first, adjust the sketch, choose the colours, mix them in the right combination, dose them carefully, and try to put on canvas what they had in mind.

Similarly, a scientist works the same way. They need time and patience to gather their thoughts and decide what to study. They draft and redraft. They collect data, which are nothing other than the colours they will paint with. They choose, mix and dose those data through mathematics, and when everything is ready they write a paper as a piece of their own making.

In the environmental sciences, and in agroecology in particular, the metaphor fits well. As if we were impressionist painters working *en plein air*, looking carefully is essential to catch the many shades of an ecosystem.

If we look at the plants growing in a meadow and give each species a colour, the result might look something like Figure 1. We see that a system left alone is a co-presence of different species which, like colours, can harmonise into a composition.

<figure>
  <img src="/images/posts/agriculture-painter/fig-1-grassland.jpg" alt="A wildflower meadow paired with a multicoloured dot painting." />
...
<figure>
  ...
  <figcaption><strong>Figure 2:</strong> Rapeseed (<em>Brassica napus</em> subsp. <em>napus</em>) field and monocolour draw from Carmenati et al., 2025<sup>1</sup>. Rapeseed field picture from Gabriela Braedle (2024 – Agroscope).</figcaption>
</figure>

Agroecology attempts to put some of those lost colours back. Not by adding any random one, but by asking which ones go well together, in what proportions, and following what design (Figure 3).

<figure>
  <img src="/images/posts/agriculture-painter/fig-3-mixed-cropping.jpg" alt="A barley and lentil intercrop paired with two complementary colour stripes." />
  <figcaption><strong>Figure 3:</strong> Mixed cropping between barley (<em>Hordeum vulgare</em> subsp. <em>nudum</em>) and lentil (<em>Lens culinaris</em> Medik.) and two colours draw from Carmenati et al., 2025<sup>1</sup>. Mixed cropping picture from Filippo Carmenati (2025 – Agroscope).</figcaption>
</figure>
...
<figure>
  <img src="/images/posts/agriculture-painter/fig-chamkhi.jpeg" alt="Diagram of an intercropped cereal and legume showing different rooting depths and rhizosphere effects." />
  <figcaption><strong>Figure 6:</strong> From Chamkhi et al. (2022)<sup>9</sup>. Complementarity in the root systems of an intercropped legume and cereal: different soil layers are explored, allowing complementarity while avoiding root–root competition.</figcaption>
</figure>

Continuing the synaesthetic game between plants and colour, a second order of complementarity comes from the different varieties within one species<sup>11</sup>, which in painters' terms would translate as the different shades of the same colour.
...
<ol class="references">
  <li>Carmenati, F. et al. <em>World Food System Center Symposium</em>. ETH Zurich, 2025. <a href="https://ethz.ch/content/dam/ethz/special-interest/dual/worldfoodsystemcenter-dam/Symposium/Posters/WFSCFoodDay2025-Carmenati-Y.pdf">Poster (PDF)</a></li>
  <li>Darwin, C. (1866). <em>[entry incomplete in source]</em></li>
  <li>Spencer, H. <em>The Principles of Biology, Vol. I.</em> BoD–Books on Demand, 2023.</li>
  <li>Goethe, J. W. von. <em>Theory of Colors.</em> 1810.</li>
  <li>MacEvoy, B. <em>Modern Color Theory (Concepts).</em> <a href="https://handprint.com/HP/WCL/wcolor.html">handprint.com</a> (2025).</li>
  <li>Ball, P. <em>Histoire vivante des couleurs.</em> 2010.</li>
  <li>Tilman, D., Isbell, F. &amp; Cowles, J. M. Biodiversity and ecosystem functioning. <em>Annual Review of Ecology, Evolution, and Systematics</em> 45, 471–493 (2014). <a href="https://doi.org/10.1146/annurev-ecolsys-120213-091917">https://doi.org/10.1146/annurev-ecolsys-120213-091917</a></li>
  <li>Bedoussac, L. et al. Ecological principles underlying the increase of productivity achieved by cereal–grain legume intercrops in organic farming. A review. <em>Agronomy for Sustainable Development</em> 35, 911–935 (2015). <a href="https://doi.org/10.1007/s13593-014-0277-7">https://doi.org/10.1007/s13593-014-0277-7</a></li>
  <li>Chamkhi, I. et al. Legume-based intercropping systems promote beneficial rhizobacterial community and crop yield under stressing conditions. <em>Industrial Crops and Products</em> 183, 114958 (2022). <a href="https://doi.org/10.1016/j.indcrop.2022.114958">https://doi.org/10.1016/j.indcrop.2022.114958</a></li>
  <li>Frankel, O. H. Analytical yield investigations on New Zealand wheat: IV. Blending varieties of wheat. <em>The Journal of Agricultural Science</em> 29, 249–261 (1939). <a href="https://doi.org/10.1017/S0021859600051777">https://doi.org/10.1017/S0021859600051777</a></li>
  <li>Reiss, E. R. &amp; Drinkwater, L. E. Cultivar mixtures: a meta-analysis of the effect of intraspecific diversity on crop yield. <em>Ecological Applications</em> 28, 62–77 (2018). <a href="https://doi.org/10.1002/eap.1629">https://doi.org/10.1002/eap.1629</a></li>
</ol>
